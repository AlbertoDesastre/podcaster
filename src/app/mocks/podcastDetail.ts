...
export interface PodcastDetailResults {
  resultCount: number;
...
const podcastDetailApiResponse: ApiResponse = {
  contents:
...
const podcastDetailContentParsed = JSON.parse(
  podcastDetailApiResponse.contents
);

export { podcastDetailApiResponse, podcastDetailContentParsed };
